  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div className={`relative w-[480px] bg-white rounded-3xl p-8 flex flex-col items-center shadow-2xl ${isClosing ? 'animate-modal-out' : 'animate-modal-in'}`}>
          <button 
            onClick={handleClose}
          ...
          <div className="w-20 h-20 bg-orange-50 rounded-full flex items-center justify-center mb-6">
            <svg className="w-10 h-10 text-[#F57323]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
            </svg>
          </div>

          <h2 className="text-3xl font-bold text-[#0B1E43] mb-3 text-center">{t('verifyAccount')}</h2>
          ...
          <div className="w-full">
            <div className="flex justify-between gap-3 mb-8">
              {otp.map((data, index) => {
                return (
                  <input
                    className="w-14 h-14 text-center text-2xl font-bold text-[#0B1E43] bg-[#F4F7FF] rounded-2xl border border-transparent focus:border-[#F57323] focus:ring-2 focus:ring-[#F57323]/20 focus:bg-white outline-none transition-all"
                    type="text"
                    name="otp"
                    maxLength="1"
                    key={index}
            ...
            <button 
              ...
              className="w-full bg-gradient-to-r from-[#9F4200] to-[#F57323] text-white font-bold py-4 rounded-full shadow-lg shadow-orange-500/20 hover:opacity-90 transition-all cursor-pointer text-lg mb-8"
            >
              {t('verifyBtn')}
            </button>
