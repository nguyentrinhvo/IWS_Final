...
export default function ForgotPassword({ isOpen, onClose, onBackToLogin, onSwitchToOtp }) {
  ...
  return (
    <>
      ...
      >
        <div 
          className="bg-white rounded-3xl w-full max-w-[480px] overflow-hidden shadow-2xl relative"
          style={{
        ...
        >
          ...
          <div className="p-10">
            <h2 className="text-[32px] font-bold text-[#0B1E43] mb-2">Forgot password?</h2>
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-[#F4F7FF] rounded-2xl py-4 px-6 text-sm outline-none focus:ring-2 focus:ring-[#F57323]/50 transition-all text-[#0B1E43]"
                />
            ...
            <button 
              ...
              className="w-full bg-[#E67E22] text-white font-bold py-4 rounded-full shadow-lg shadow-orange-500/20 hover:bg-[#D35400] transition-all cursor-pointer text-lg mt-2"
            >
              Continue
            </button>
            ...
            <button 
              ...
              className="flex items-center justify-center space-x-2 text-[#9F4200] font-bold hover:underline cursor-pointer mt-4 mx-auto"
            >
