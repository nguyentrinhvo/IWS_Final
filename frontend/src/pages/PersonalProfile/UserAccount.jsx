...
export default function UserAccount() {
  ...
  return (
    <div className="w-full bg-[#F5F7FA] min-h-screen py-10">
      <div className="max-w-[1320px] mx-auto px-4 flex gap-[15px] items-start">
        <div className="w-[300px] flex-shrink-0 bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden sticky top-10 flex flex-col">
          <div className="p-5 flex items-center gap-4">
            <div className="relative group cursor-pointer" onClick={triggerFileInput}>
              <div className="w-12 h-12 rounded-full bg-[#0194F3] flex items-center justify-center text-white font-bold text-xl overflow-hidden shadow-inner flex-shrink-0">
                {currentUser?.avatar ? (
            ...
            <div className="flex flex-col min-w-0">
              <span className="text-sm font-bold text-gray-800 truncate">{currentUser?.fullName || 'The Anh'}</span>
          ...
          <div className="py-2">
            {menuItems.map((item) => (
              <button
                ...
                className={`w-full flex items-center gap-3 px-5 py-3 text-[13px] font-semibold transition-all cursor-pointer border border-transparent ${
                  tab === item.id 
