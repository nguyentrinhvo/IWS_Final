...
export default function PopularDestinations() {
  ...
  const destinations = [
    ...
    { 
      ...
      titleKey: 'daLatTitle', 
      hotels: 342, 
      image: 'https://static.vinwonders.com/production/canh-dep-da-lat-banner.jpg', 
      gridClass: 'col-span-1 row-span-2' 
    },
    { 
      id: 'quyNhon', 
      titleKey: 'quyNhonTitle', 
      hotels: 128, 
      image: 'https://cdn3.ivivu.com/2023/12/du-lich-binh-dinh-ivivu.jpg', 
      gridClass: 'col-span-1 row-span-1' 
    },
    { 
      id: 'vungTau', 
      titleKey: 'vungTauTitle', 
      hotels: 415, 
    ...
    { 
      id: 'nhaTrang', 
      titleKey: 'nhaTrangTitle', 
      hotels: 610, 
      image: 'https://media.vneconomy.vn/images/upload/2024/05/15/nha-trang-2.jpg', 
      gridClass: 'col-span-1 row-span-2' 
    },
    { 
      id: 'daNang', 
      titleKey: 'daNangTitle', 
      hotels: 850, 
      image: 'https://danangaztravel.com/wp-content/uploads/2025/01/ba-na-hills-tai-da-nang.jpg', 
      gridClass: 'col-span-2 row-span-1' 
    },
    { 
      id: 'phanThiet', 
      titleKey: 'phanThietTitle', 
      hotels: 205, 
      image: 'https://static.vinwonders.com/production/phan-thiet-4.jpg', 
      gridClass: 'col-span-1 row-span-1' 
    },
    { 
      id: 'phuYen', 
      titleKey: 'phuYenTitle', 
      hotels: 98, 
      image: 'https://vj-prod-website-cms.s3.ap-southeast-1.amazonaws.com/depositphotos595528698xl-1736473488122.jpg', 
      gridClass: 'col-span-1 row-span-1' 
    }
  ];
  ...
  return (
    <section className="w-full flex flex-col gap-4">
      ...
      <div className="w-full h-[970px] grid grid-cols-3 grid-rows-4 gap-[15px] mt-4">
        {destinations.map((dest) => (
          ...
          >
            ...
            <div className="absolute bottom-5 left-5 flex flex-col gap-0.5">
              ...
              <p className="text-white text-[16px] font-semibold [-webkit-text-stroke:0.5px_black]">
                {dest.hotels} {t('hotelsCount')}
              </p>
            </div>
          </div>
        ))}
