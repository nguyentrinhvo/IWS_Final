  ...
  if (loading) {
    return (
      <div className="h-[60vh] flex flex-col items-center justify-center space-y-4">
        <RefreshCcw className="w-12 h-12 text-[#7C4A4A] animate-spin opacity-20" />
        <p className="text-sm font-bold text-gray-400 uppercase tracking-widest animate-pulse">Loading Tour Details...</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500 pb-12">
      ...
      <div className="flex flex-col space-y-2">
        <h1 className="text-2xl font-black text-slate-800 uppercase tracking-tight">Update Tour</h1>
      </div>
