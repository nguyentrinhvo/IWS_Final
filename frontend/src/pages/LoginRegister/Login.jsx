...
export default function Login({ isOpen, onClose, onSwitchToRegister, onSwitchToForgotPassword, onLoginSuccess }) {
  ...
  return (
    <>
      ...
      >
        <div
          className={`w-full max-w-[448px] h-auto max-h-[calc(100vh-2rem)] bg-white rounded-3xl relative flex flex-col px-6 py-8 sm:px-8 sm:py-10 shadow-2xl overflow-y-auto ${isClosing ? 'modal-out' : 'modal-in'}`}
