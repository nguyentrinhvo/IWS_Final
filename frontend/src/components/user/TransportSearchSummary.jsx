...
const TransportSearchSummary = ({ search, onEditSearch }) => {
  const { from, to, departDate, returnDate, passengers, tripType } = search;
        ...
        <div className="flex-1 flex flex-wrap items-center gap-x-6 gap-y-2 text-white">
          ...
          <div className="flex items-center space-x-2">
            <div className="flex flex-col">
              ...
              <span className="font-bold text-lg leading-tight">{from}</span>
            </div>
            ...
            <div className="flex flex-col">
              ...
              <span className="font-bold text-lg leading-tight">{to}</span>
            </div>
          </div>
          ...
          {/* Passengers */}
          <div className="flex flex-col">
            <span className="text-[11px] text-white/60 uppercase font-medium">Tickets</span>
...
export default TransportSearchSummary;
